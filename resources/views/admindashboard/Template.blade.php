                ...
                <div class="row">
                    <div class="col-12 menu-lists">
                        <ul class="menu-links">
                            ...
                            <li><i class="fab fa-stack-overflow mr-2" style="font-size: 20px"></i><a href="/adminproduct">STOCK</a></li>
                            <li><i class="fa-solid fa-people-roof"></i><a href="/usermanagement">USER-Managment</a></li>
